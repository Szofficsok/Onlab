...
public class Generator3D : MonoBehaviour
{
            ...
            if (path != null)
            {
                ...
                foreach (var pos in path)
                {
                    if (grid[pos] == CellType.Hallway)
                    {
                        ...
                        PlaceHallway(pos + new Vector3Int(0, 1, 0));
                    }
                }
            }
        }
    ...
    {
        GameObject go = Instantiate(room, location, Quaternion.identity);
    ...
    void PlaceHallway(Vector3Int location)
    {
        ...
        GameObject go = Instantiate(hallway, location, Quaternion.identity);
    }

    void PlaceStairs(Vector3Int location)
    {

        GameObject go = Instantiate(stairs, location, Quaternion.identity);
    }
}
